...
const incomeCategories = ['Salary', 'Bonus', 'Gifts', 'Investments', 'Side Hustle', 'Other'];
...
const AddTransactionDialog: React.FC<AddTransactionDialogProps> = ({ 
  ...
  const { addTransaction, updateTransaction, groups } = useTransactions();
      ...
      <DialogContent className="sm:max-w-[425px] max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-2">
          <Tabs 
            ...
            onValueChange={(value) => handleFormChange('type', value as 'expense' | 'income')}
          >
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select 
              ...
              onValueChange={(val) => handleFormChange('groupId', val === "no-group" ? undefined : val)}
