...
const Dashboard = () => {
  ...
  // Recent transactions
  const recentPersonalTransactions = getRecentTransactions(personalTransactions);
  ...
  const renderSummaryCards = (summary) => (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-income">₹{summary.income.toFixed(2)}</div>
          <p className="text-xs text-muted-foreground">
            Total income for {currentDate.toLocaleDateString(undefined, { month: 'long', year: 'numeric' })}
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-expense">₹{summary.expenses.toFixed(2)}</div>
          <p className="text-xs text-muted-foreground">
            Total expenses for {currentDate.toLocaleDateString(undefined, { month: 'long', year: 'numeric' })}
          </p>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <p className="text-xs text-muted-foreground">
            Net balance for {currentDate.toLocaleDateString(undefined, { month: 'long', year: 'numeric' })}
          </p>
        </CardContent>
      </Card>
    </div>
    ...
    <Card className="dashboard-card">
      ...
      <CardContent>
        {categoryData.length > 0 ? (
          <div className="h-[250px]"> {/* Reduced height from 300px to 250px */}
